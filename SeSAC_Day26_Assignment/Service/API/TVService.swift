...
typealias TVShowResponseResult = Result<TMDbAPIResponse<[TVShowEntity.Response]>?, NetworkError>
typealias TVShowDetailResponseResult = Result<TMDbAPIResponse<TVShowEntity.Response>?, NetworkError>

protocol TVServiceType {
  func getTrendingTVs(timeWindow: TVShowEntity.TimeWindow, language: String, completion: @escaping (TVShowResponseResult) -> Void)
...
final class TVService: TVServiceType {
  ...
  func getTrendingTVs(timeWindow: TVShowEntity.TimeWindow, language: String = Locale.currentLanguageAndCountryCode, completion: @escaping (TVShowResponseResult) -> Void) {
  ...
  func getPopularTVs(language: String = Locale.currentLanguageAndCountryCode, completion: @escaping (TVShowResponseResult) -> Void) {
    requestTVData(.getPopularTVs(language: language), responseType: [TVShowEntity.Response].self, completion: completion)
  }
  
  func getTopRatedTVs(language: String = Locale.currentLanguageAndCountryCode, completion: @escaping (TVShowResponseResult) -> Void) {
    requestTVData(.getTopRatedTVs(language: language), responseType: [TVShowEntity.Response].self, completion: completion)
  }
  
  func searchTV(query: String, language: String = Locale.currentLanguageAndCountryCode, completion: @escaping (TVShowResponseResult) -> Void) {
    requestTVData(.searchTV(query: query, language: language), responseType: [TVShowEntity.Response].self, completion: completion)
  }
  
  func getTVDetails(id: Int, language: String = Locale.currentLanguageAndCountryCode, completion: @escaping (TVShowDetailResponseResult) -> Void) {
    requestTVData(.getTVDetails(id: id, language: language), responseType: TVShowEntity.Response.self, completion: completion)
  }
  
  func getTVRecommendations(id: Int, language: String = Locale.currentLanguageAndCountryCode, completion: @escaping (TVShowResponseResult) -> Void) {
    requestTVData(.getTVRecommendations(id: id, language: language), responseType: [TVShowEntity.Response].self, completion: completion)
  }
  
  private func requestTVData<T>(_ target: TvAPI, responseType: T.Type, completion: @escaping (Result<TMDbAPIResponse<T>?, NetworkError>) -> Void) where T: Decodable {
