...
enum TVShowEntity {
  ...
  struct Response: Decodable, Identifiable {
    ...
    init(from decoder: Decoder) throws {
      ...
      self.genreIDs = try container.decodeIfPresent([Int].self, forKey: TVShowEntity.Response.CodingKeys.genreIDs)
      ...
      self.overview = try container.decodeIfPresent(String.self, forKey: TVShowEntity.Response.CodingKeys.overview)
